...
def nokaut_api(argv):
    ...
    sock = urllib.urlopen("http://api.nokaut.pl/?format=xml&key="+key+"&method=nokaut.product.getByKeyword&keyword="+product+"&filters[price][from]=1200&filters[price][to]=2200")
